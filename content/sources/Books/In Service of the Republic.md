...
status: read
created: 2022-11-15 21:50:47
finished: 2022-11-15 21:50:47
dg-publish: true
---

![cover](http://books.google.com/books/content?id=2Sm-DwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api)
1. [[#In Service of the Republic|In Service of the Republic]]
1. [[#What objectives of public policy are appropriate?"|What objectives of public policy are appropriate?"]]
	1. [[#What objectives of public policy are appropriate?"#Traditional Thinking:|Traditional Thinking:]]
	1. [[#What objectives of public policy are appropriate?"#Proposed thinking|Proposed thinking]]
1. [[#People respond to incentives|People respond to incentives]]
				...
				1. [[#Caution in setting up incentives around statistical measures|Caution in setting up incentives around statistical measures]]
				1. [[#People’s responses to incentives can be wonky|People’s responses to incentives can be wonky]]
			1. [[#cost of acquiring and processing information|cost of acquiring and processing information]]
			1. [[#thinking across long time horizons|thinking across long time horizons]]
1. [[#Price System|Price System]]
	1. [[#Price System#Four forces of stabilization —|Four forces of stabilization —]]
1. [[#More competition Always|More competition Always]]
	...
	1. [[#More competition Always#The government as a source of market power|The government as a source of market power]]
1. [[#General Equilibrium Effects|General Equilibrium Effects]]
1. [[#Go to the root cause, use the smallest possible force|Go to the root cause, use the smallest possible force]]
1. [[#Redistribution is fraught with trouble|Redistribution is fraught with trouble]]
	1. [[#Redistribution is fraught with trouble#Difficulties with paternalism|Difficulties with paternalism]]
	1. [[#Redistribution is fraught with trouble#Poverty will not be solved by redistribution|Poverty will not be solved by redistribution]]
...
1. [[#Private Solutions for Market Failiures|Private Solutions for Market Failiures]]
1. [[#Calculations in Public Policy|Calculations in Public Policy]]
1. [[#Ask the right question|Ask the right question]]
					1. [[#People’s responses to incentives can be wonky#Tax|Tax]]
					1. [[#People’s responses to incentives can be wonky#Deficit|Deficit]]
					1. [[#People’s responses to incentives can be wonky#Formal process helps|Formal process helps]]
1. [[#Decentralisation|Decentralisation]]
...
1. [[#Evolutionary Change for the society, revolutionary change for the government|Evolutionary Change for the society, revolutionary change for the government]]
1. [[#Cross the river by feeling the stones|Cross the river by feeling the stones]]
1. [[#be careful of isomorphic mimicry|be careful of isomorphic mimicry]]
1. [[#Free-riding on state capacity outside India|Free-riding on state capacity outside India]]
1. [[#Public policy work is a test match, not an IPL.|Public policy work is a test match, not an IPL.]]
	1. [[#Public policy work is a test match, not an IPL.#Policymaking on the election clock”|Policymaking on the election clock”]]
	1. [[#Public policy work is a test match, not an IPL.#Playing the long game|Playing the long game]]
1. [[#What is hard and what is easy|What is hard and what is easy]]
	1. [[#What is hard and what is easy#Four dimensions of complexity|Four dimensions of complexity]]
	1. [[#What is hard and what is easy#Solutions that reduce complexity in some dimensions|Solutions that reduce complexity in some dimensions]]
	1. [[#What is hard and what is easy#Learn to walk before you run Once|Learn to walk before you run Once]]
1. [[#Confident policymakers work in the open|Confident policymakers work in the open]]
...
1. [[#The public policy process|The public policy process]]
		1. [[#Learn to walk before you run Once#The policy pipeline|The policy pipeline]]
1. [[#Do fewer things|Do fewer things]]
1. [[#Rolling up your sleeves to build state capacity”|Rolling up your sleeves to build state capacity”]]
...
1. [[#Proposed thinking|Proposed thinking]]
...
Financial economic policy is about addressing these four objectives: combat negative externalities, combat [[Asymmetric Information|asymmetric information]], invent money, and establish an investment banker for the government.
